...
export class PanaromaswapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save PanaromaswapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save PanaromaswapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("PanaromaswapFactory", id.toString(), this);
  }

  static load(id: string): PanaromaswapFactory | null {
    return store.get("PanaromaswapFactory", id) as PanaromaswapFactory | null;
  }
...
export class PanaromaswapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save PanaromaswapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save PanaromaswapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("PanaromaswapDayData", id.toString(), this);
  }

  static load(id: string): PanaromaswapDayData | null {
    return store.get("PanaromaswapDayData", id) as PanaromaswapDayData | null;
  }
